...
$(document).ready(function () {
    ...
    tableElement.dataTable({
        ...
        //    },
            {
                aTargets: [ 3 ],
				mDataProp: 'metas',              // Column number which needs to be modified
                sClass  : 'centered-cell',     // Optional - class to be applied to this table cell
				sType: 'numeric'							
            },
			{
            ...
            },
			{
				...
				mDataProp: 'idUser',
                 bSortable: false,             // Column is not sortable
                mRender  : function (data, type) {
                    return '<div class="btn-group"><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"> Trimestres <span class="caret"></span></button><ul class="dropdown-menu" role="menu"> <li><a href="almacenesTrimestre.php?almacen='+ data + '&date=2014-01-01&tri=Trimestre 1 ">Trimestre 1</a></li><li><a href="almacenesTrimestre.php?almacen='+ data + '&date=2014-04-01&tri=Trimestre 2">Trimestre 2</a></li><li><a href="almacenesTrimestre.php?almacen='+ data + '&date=2014-07-01&tri=Trimestre 3">Trimestre 3</a></li><li><a href="almacenesTrimestre.php?almacen='+ data + '&date=2014-10-01&tri=Trimestre 4">Trimestre 4</a></li></ul></div>';
                },
                sClass   : 'centered-cell'    // Optional - class to be applied to this table cell
            }
        ],
