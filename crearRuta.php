...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblCordenadas (strName, strTitle, textDescripcion, textCordenadas, intCategoria, intIcono, intPadre, intActivo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="panel panel-default">
                <div class="panel-heading"><h3>Nueva ruta</h3></div>
                      ...
                      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
                        <div class="form-group">
                          ...
                          <div class="form-group none">
                            ...
                            <textarea class="form-control" name="textDescripcion" rows="8"><p>Titulo<p/><p>Municipio: nombre municipio<p/><p>Direccion<p/><p>Tres (3) principales competidores de DOW en el negocio de potreros:<br>Respuesta <br>Respuesta <br>Respuesta </p></textarea>
                          </div>
                          <div class="form-group none">
                          ...
                          <div class="form-group none">
                            ...
                            <select class="form-control" name="intCategoria" value="5">
                              
                            </select>
                          </div>
                          <div class="form-group none">
                            <label for="exampleInputEmail1">Icono:</label>
                            <select class="form-control" name="intIcono" value="">
>
                            </select>
                          </div>
                          ...
                          <div class="checkbox none">
                            <label>
                              <input type="checkbox" name="intActivo" value="1" checked> Activo
                            </label>
                          </div>
                          
                          <button type="submit" class="btn btn-default">Insertar ruta</button>
