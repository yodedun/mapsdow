...
$query_ConsultaCordenadas = "SELECT tblCordenadas.idCordenadas, tblCordenadas.strName, tblCordenadas.textCordenadas, tblCordenadas.intCategoria, tblCordenadas.intActivo, tblCategorias.strTipo, tblCordenadas.textCordenadas, tblCordenadas.strTitle FROM tblCordenadas , tblCategorias WHERE tblCordenadas.intCategoria = tblCategorias.idCategoria and tblCordenadas.intCategoria = 1";
...
<div class="col-lg-12 text-right">
                       <p><a class="btn btn-danger" href="add_pais.php">Insertar pais</a> - <a class="btn btn-danger" href="index.php">Regresar</a></p>
 </div>
                        ...
                        <?php do { ?>                          
                            <tr>
                                  ...
                                  <td>
                                   ...
                                   <td>
                                    <?php echo $row_ConsultaCordenadas['strTipo']; ?>
                                  </td>
                                  
                                  <td class="col-lg-1">
                                    <?php echo $row_ConsultaCordenadas['intActivo']; ?>
                                  </td>
                                  <td class="col-lg-1">
