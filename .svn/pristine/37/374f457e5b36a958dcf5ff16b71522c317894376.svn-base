                ...
                <div class="panel-heading"><h3>Paises</h3></div>
                	<div class="panel-body">
                      <div class="col-lg-12">
                      	...
                      	<a class="btn btn-danger" href="add_pais.php">Insertar Pais</a> - <a class="btn btn-danger" href="view_paises.php">Previsualizar paises</a> - <a class="btn btn-danger" href="index.php">Regresar</a>
                      </div>
                      <table class="table">
                        <thead>
                          		<tr>
