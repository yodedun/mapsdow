...
conPais.idCordenadas,
	conPais.strName,
	conPais.textCordenadas,
	conPais.intCategoria,
	conPais.intPadre,
	conPais.namePais,
	paraPadre.strName AS namePadre
from
 (
...
<div class="col-lg-12 text-right">
                       <p><a class="btn btn-danger" href="add_zonas.php">Insertar zona</a> - <a class="btn btn-danger" href="index.php">Regresar</a></p>
 </div>
                      ...
                      <table class="table">
                        ...
                        <?php do { ?>                          
                            <tr>
                                  ...
                                  <td>
                                    <?php echo $row_ConsultaCordenadas['namePadre']; ?>
                                  </td>
